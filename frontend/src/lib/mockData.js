const detailRecords = {
  'A-NIMBUS': {
    ...
    autonomy_reason: 'High-risk account (score 20) requires human review before action',
    actions_taken: [
  ...
  'A-VERTEX': {
    ...
    status: 'needs_approval',
    autonomy_level: 'needs_approval',
    autonomy_reason: 'Account flagged for review — awaiting human approval',
    actions_taken: [
...
export const reviewSimulation = [
  ...
  { type: 'warning', message: 'Nimbus Analytics ready for review', time: '10:03 AM' },
  { type: 'analyzing', message: 'Analyzing Vertex Systems (2/3)', time: '10:04 AM' },
  { type: 'warning', message: 'Vertex Systems ready for review', time: '10:04 AM' },
  { type: 'analyzing', message: 'Analyzing Orion Global (3/3)', time: '10:05 AM' },
  { type: 'warning', message: 'Orion Global ready for review', time: '10:05 AM' },
  { type: 'complete', message: 'Review complete. 3 accounts ready for approval.', time: '10:05 AM' },
]
